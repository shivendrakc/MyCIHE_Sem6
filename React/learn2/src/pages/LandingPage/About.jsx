...
const About = () => {
  return (
    <div className="bg-white">
        ...
        <div className="relative h-64 bg-gradient-to-b from-sky-200 to-sky-400 overflow-hidden mt-13">
        ...
        <div className="container mx-auto px-4 py-25 grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Image Grid */}
          <div className="grid grid-cols-2 grid-rows-2 gap-">
            <img src={ Pic3 } alt="Instructor Student" className=" rounded-lg" />
            <img src={ Pic2 } alt="Woman Driving" className="rounded-lg" />
            <img src={ Pic1} alt="Car Interior" className="rounded-lg" />
          </div>
