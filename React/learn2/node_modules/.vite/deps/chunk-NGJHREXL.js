...
true ? CircularProgress.propTypes = {
   ...
   * @default false
   */
  disableShrink: chainPropTypes(import_prop_types11.default.bool, (props) => {
...
var Portal = React15.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React15.isValidElement(children2) ? getReactElementRef(children2) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
...
var PopperTooltip = React16.forwardRef(function PopperTooltip2(props, forwardedRef) {
  const {
    anchorEl,
    children: children2,
    direction,
...
var Popper = React16.forwardRef(function Popper2(props, forwardedRef) {
  const {
    anchorEl,
    children: children2,
  ...
  return (0, import_jsx_runtime8.jsx)(Portal_default, {
    disablePortal,
    container,
    children: (0, import_jsx_runtime8.jsx)(PopperTooltip, {
      anchorEl,
      direction,
      disablePortal,
      modifiers,
...
var Popper3 = React17.forwardRef(function Popper4(inProps, ref) {
  const isRtl = useRtl();
  const props = useDefaultProps({
    props: inProps,
    name: "MuiPopper"
  ...
  return (0, import_jsx_runtime9.jsx)(PopperRoot, {
    as: component,
...
true ? Chip.propTypes = {
   ...
   */
  clickable: import_prop_types17.default.bool,
  /**
   * The color of the component.
   * It supports both default and custom theme colors, which can be added as shown in the
   * [palette customization guide](https://mui.com/material-ui/customization/palette/#custom-colors).
   ...
   * @default false
   */
  skipFocusWhenDisabled: import_prop_types17.default.bool,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
   ...
   * @default 'filled'
   */
  variant: import_prop_types17.default.oneOfType([import_prop_types17.default.oneOf(["filled", "outlined"]), import_prop_types17.default.string])
} : void 0;
...
var TextareaAutosize = React20.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  const {
    onChange,
    maxRows,
    minRows = 1,
  ...
  const heightRef = React20.useRef(null);
  const hiddenTextareaRef = React20.useRef(null);
  const calculateTextareaStyles = React20.useCallback(() => {
  ...
  const frameRef = React20.useRef(-1);
  useEnhancedEffect_default(() => {
...
var InputBase = React23.forwardRef(function InputBase2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiInputBase"
  });
  ...
  return (0, import_jsx_runtime13.jsxs)(React23.Fragment, {
...
var Fade = React24.forwardRef(function Fade2(props, ref) {
  const theme = useTheme();
...
var Backdrop = React25.forwardRef(function Backdrop2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiBackdrop"
  });
...
var ButtonGroupContext = React26.createContext({});
if (true) {
...
var ButtonGroupButtonContext = React27.createContext(void 0);
if (true) {
...
var Button = React28.forwardRef(function Button2(inProps, ref) {
  const contextProps = React28.useContext(ButtonGroupContext_default);
  const buttonGroupButtonContextPositionClassName = React28.useContext(ButtonGroupButtonContext_default);
  ...
  const loadingId = useId_default(idProp);
  const loadingIndicator = loadingIndicatorProp ?? (0, import_jsx_runtime16.jsx)(CircularProgress_default, {
    "aria-labelledby": loadingId,
    color: "inherit",
    size: 16
  });
  ...
  const startIcon = (startIconProp || loading && loadingPosition === "start") && (0, import_jsx_runtime16.jsx)(ButtonStartIcon, {
    className: classes.startIcon,
    ownerState,
    children: startIconProp || (0, import_jsx_runtime16.jsx)(ButtonLoadingIconPlaceholder, {
      className: classes.loadingIconPlaceholder,
      ownerState
    })
  });
  const endIcon = (endIconProp || loading && loadingPosition === "end") && (0, import_jsx_runtime16.jsx)(ButtonEndIcon, {
    className: classes.endIcon,
    ownerState,
    children: endIconProp || (0, import_jsx_runtime16.jsx)(ButtonLoadingIconPlaceholder, {
      className: classes.loadingIconPlaceholder,
      ownerState
    })
  });
  ...
  const loader = typeof loading === "boolean" ? (
    ...
    (0, import_jsx_runtime16.jsx)("span", {
      ...
      children: loading && (0, import_jsx_runtime16.jsx)(ButtonLoadingIndicator, {
        className: classes.loadingIndicator,
        ownerState,
  ...
  return (0, import_jsx_runtime16.jsxs)(ButtonRoot, {
    ownerState,
...
true ? Button.propTypes = {
   ...
   * @default 'primary'
   */
  color: import_prop_types22.default.oneOfType([import_prop_types22.default.oneOf(["inherit", "primary", "secondary", "success", "error", "info", "warning"]), import_prop_types22.default.string]),
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
   ...
   * @default <CircularProgress color="inherit" size={16} />
   */
  loadingIndicator: import_prop_types22.default.node,
  /**
   * The loading indicator can be positioned on the start, end, or the center of the button.
   * @default 'center'
   */
  loadingPosition: import_prop_types22.default.oneOf(["center", "end", "start"]),
  /**
   * The size of the component.
   * `small` is equivalent to the dense button styling.
   * @default 'medium'
...
function FocusTrap(props) {
  ...
  return (0, import_jsx_runtime17.jsxs)(React29.Fragment, {
  ...
  return (0, import_jsx_runtime18.jsx)(Portal_default, {
    ...
    children: (0, import_jsx_runtime18.jsxs)(RootSlot, {
      ...
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime18.jsx)(BackdropSlot, {
        ...
        open,
        children: React31.cloneElement(children2, childProps)
      })]
    })
  });
});
...
var DialogContext = React32.createContext({});
if (true) {
...
var Dialog = React33.forwardRef(function Dialog2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiDialog"
  });
  ...
  const backdropClick = React33.useRef();
  ...
  const dialogContextValue = React33.useMemo(() => {
    return {
  ...
  return (0, import_jsx_runtime19.jsx)(RootSlot, {
    ...
    children: (0, import_jsx_runtime19.jsx)(TransitionSlot, {
      ...transitionSlotProps,
      children: (0, import_jsx_runtime19.jsx)(ContainerSlot, {
        onMouseDown: handleMouseDown,
        ...containerSlotProps,
        children: (0, import_jsx_runtime19.jsx)(PaperSlot, {
          ...
          ...paperSlotProps,
          children: (0, import_jsx_runtime19.jsx)(DialogContext_default.Provider, {
...
true ? Dialog.propTypes = {
   ...
   * @default true
   */
  "aria-modal": import_prop_types25.default.oneOfType([import_prop_types25.default.oneOf(["false", "true"]), import_prop_types25.default.bool]),
  /**
   * A backdrop component. This prop enables custom backdrop rendering.
   * @deprecated Use `slots.backdrop` instead. While this prop currently works, it will be removed in the next major version.
   * Use the `slots.backdrop` prop to make your application ready for the next version of Material UI.
   ...
   * })
   */
  BackdropComponent: import_prop_types25.default.elementType,
  /**
   * @ignore
   */
   ...
   * @default false
   */
  disableEscapeKeyDown: import_prop_types25.default.bool,
  /**
   * If `true`, the dialog is full-screen.
   * @default false
   */
  fullScreen: import_prop_types25.default.bool,
  /**
   ...
   * @default 'paper'
   */
  scroll: import_prop_types25.default.oneOf(["body", "paper"]),
  /**
   * The props used for each slot inside.
   * @default {}
   */
  slotProps: import_prop_types25.default.shape({
    backdrop: import_prop_types25.default.oneOfType([import_prop_types25.default.func, import_prop_types25.default.object]),
    container: import_prop_types25.default.oneOfType([import_prop_types25.default.func, import_prop_types25.default.object]),
    paper: import_prop_types25.default.oneOfType([import_prop_types25.default.func, import_prop_types25.default.object]),
    root: import_prop_types25.default.oneOfType([import_prop_types25.default.func, import_prop_types25.default.object]),
    transition: import_prop_types25.default.oneOfType([import_prop_types25.default.func, import_prop_types25.default.object])
  }),
  /**
   * The components used for each slot inside.
   * @default {}
  ...
  slots: import_prop_types25.default.shape({
    backdrop: import_prop_types25.default.elementType,
    container: import_prop_types25.default.elementType,
    paper: import_prop_types25.default.elementType,
    root: import_prop_types25.default.elementType,
    transition: import_prop_types25.default.elementType
  }),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
   ...
   * @deprecated Use `slots.transition` instead. This prop will be removed in a future major release. See [Migrating from deprecated APIs](/material-ui/migration/migrating-from-deprecated-apis/) for more details.
   */
  TransitionComponent: import_prop_types25.default.elementType,
  /**
   * The duration for the transition, in milliseconds.
   * You may specify a single timeout for all transitions, or individually with an object.
   * @default {
   ...
   */
  TransitionProps: import_prop_types25.default.object
} : void 0;
...
var DialogActions = React34.forwardRef(function DialogActions2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiDialogActions"
  });
  ...
  return (0, import_jsx_runtime20.jsx)(DialogActionsRoot, {
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    ...other
...
var DialogContent = React35.forwardRef(function DialogContent2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiDialogContent"
  });
  ...
  return (0, import_jsx_runtime21.jsx)(DialogContentRoot, {
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    ...other
...
var FilledInput = React36.forwardRef(function FilledInput2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiFilledInput"
  });
  ...
  return (0, import_jsx_runtime22.jsx)(InputBase_default, {
    slots: {
      root: RootSlot,
      input: InputSlot
    },
...
var FormControl = React37.forwardRef(function FormControl2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiFormControl"
  });
  ...
  const [adornedStart, setAdornedStart] = React37.useState(() => {
    ...
    if (children2) {
      React37.Children.forEach(children2, (child) => {
  ...
  const onFilled = React37.useCallback(() => {
    setFilled(true);
  }, []);
  const onEmpty = React37.useCallback(() => {
    setFilled(false);
  }, []);
  ...
  return (0, import_jsx_runtime23.jsx)(FormControlContext_default.Provider, {
    value: childContext,
    children: (0, import_jsx_runtime23.jsx)(FormControlRoot, {
      as: component,
      ownerState,
      className: clsx_default(classes.root, className),
      ref,
...
var FormHelperText = React38.forwardRef(function FormHelperText2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiFormHelperText"
  });
  ...
  return (0, import_jsx_runtime24.jsx)(FormHelperTextRoot, {
    as: component,
    className: clsx_default(classes.root, className),
    ref,
    ...other,
...
var FormLabel = React39.forwardRef(function FormLabel2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiFormLabel"
  });
  ...
  return (0, import_jsx_runtime25.jsxs)(FormLabelRoot, {
    as: component,
    ownerState,
    className: clsx_default(classes.root, className),
    ref,
    ...other,
    children: [children2, fcs.required && (0, import_jsx_runtime25.jsxs)(AsteriskComponent, {
      ownerState,
      "aria-hidden": true,
...
var Grow = React40.forwardRef(function Grow2(props, ref) {
  const {
    addEndListener,
    appear = true,
    children: children2,
  ...
  const autoTimeout = React40.useRef();
  const theme = useTheme();
  ...
  return (0, import_jsx_runtime26.jsx)(TransitionComponent, {
    appear,
    in: inProp,
    nodeRef,
    onEnter: handleEnter,
...
var Input = React41.forwardRef(function Input2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiInput"
  });
...
var InputAdornment = React42.forwardRef(function InputAdornment2(inProps, ref) {
  ...
  return (0, import_jsx_runtime28.jsx)(FormControlContext_default.Provider, {
    value: null,
    children: (0, import_jsx_runtime28.jsx)(InputAdornmentRoot, {
      as: component,
      ownerState,
      className: clsx_default(classes.root, className),
      ref,
      ...other,
      children: typeof children2 === "string" && !disableTypography ? (0, import_jsx_runtime28.jsx)(Typography_default, {
        color: "textSecondary",
        children: children2
      }) : (0, import_jsx_runtime28.jsxs)(React42.Fragment, {
        children: [position === "start" ? (
          /* notranslate needed while Google Translate will not fix zero-width space issue */
          _span2 || (_span2 = (0, import_jsx_runtime28.jsx)("span", {
            className: "notranslate",
            "aria-hidden": true,
            children: "​"
          }))
...
true ? InputAdornment.propTypes = {
   ...
   * @default false
   */
  disablePointerEvents: import_prop_types34.default.bool,
  /**
   ...
   */
  position: import_prop_types34.default.oneOf(["end", "start"]).isRequired,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var InputLabel = React43.forwardRef(function InputLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime29.jsx)(InputLabelRoot, {
    "data-shrink": shrink,
    ref,
    className: clsx_default(classes.root, className),
    ...other,
...
var ListContext = React44.createContext({});
if (true) {
...
var List = React45.forwardRef(function List2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiList"
  });
  ...
  return (0, import_jsx_runtime30.jsx)(ListContext_default.Provider, {
    value: context,
    children: (0, import_jsx_runtime30.jsxs)(ListRoot, {
      as: component,
      className: clsx_default(classes.root, className),
      ref,
      ownerState,
...
var ListItemButton = React46.forwardRef(function ListItemButton2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiListItemButton"
  });
  ...
  const listItemRef = React46.useRef(null);
  useEnhancedEffect_default2(() => {
    if (autoFocus) {
  ...
  return (0, import_jsx_runtime31.jsx)(ListContext_default.Provider, {
    value: childContext,
    children: (0, import_jsx_runtime31.jsx)(ListItemButtonRoot, {
      ref: handleRef,
...
var ListItemSecondaryAction = React47.forwardRef(function ListItemSecondaryAction2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiListItemSecondaryAction"
  });
  ...
  return (0, import_jsx_runtime32.jsx)(ListItemSecondaryActionRoot, {
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    ...other
...
var ListItem = React48.forwardRef(function ListItem2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiListItem"
  });
  ...
  const children2 = React48.Children.toArray(childrenProp);
  ...
  if (hasSecondaryAction) {
    ...
    return (0, import_jsx_runtime33.jsx)(ListContext_default.Provider, {
      value: childContext,
      children: (0, import_jsx_runtime33.jsxs)(ListItemContainer, {
  ...
  return (0, import_jsx_runtime33.jsx)(ListContext_default.Provider, {
    value: childContext,
    children: (0, import_jsx_runtime33.jsxs)(Root, {
      ...rootProps,
      as: Component,
      ref: handleRef,
      ...!isHostComponent_default(Root) && {
      ...
      ...componentProps,
      children: [children2, secondaryAction && (0, import_jsx_runtime33.jsx)(ListItemSecondaryAction_default, {
...
true ? ListItem.propTypes = {
  ...
  children: chainPropTypes(import_prop_types39.default.node, (props) => {
    const children2 = React48.Children.toArray(props.children);
   ...
   */
  ContainerProps: import_prop_types39.default.object,
  /**
   * If `true`, compact vertical padding designed for keyboard and mouse input is used.
   * The prop defaults to the value inherited from the parent List component.
   * @default false
   ...
   */
  secondaryAction: import_prop_types39.default.node,
  /**
   * The extra props for the slot components.
   * You can override the existing props or add new ones.
   *
...
var MenuList = React49.forwardRef(function MenuList2(props, ref) {
  const {
    // private
    // eslint-disable-next-line react/prop-types
    actions,
  ...
  React49.Children.forEach(children2, (child, index) => {
  ...
  const items = React49.Children.map(children2, (child, index) => {
    if (index === activeItemIndex) {
      ...
      return React49.cloneElement(child, newChildProps);
    }
    return child;
  });
...
var Popover = React50.forwardRef(function Popover2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiPopover"
  });
...
var Menu = React51.forwardRef(function Menu2(inProps, ref) {
  ...
  const menuListActionsRef = React51.useRef(null);
  ...
  let activeItemIndex = -1;
  React51.Children.map(children2, (child, index) => {
  ...
  return (0, import_jsx_runtime36.jsx)(MenuRoot, {
    ...
    children: (0, import_jsx_runtime36.jsx)(ListSlot, {
...
var OutlinedInput = React53.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime38.jsx)(InputBase_default, {
    ...
    renderSuffix: (state) => (0, import_jsx_runtime38.jsx)(NotchedOutlineRoot2, {
      ownerState,
      className: classes.notchedOutline,
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime38.jsxs)(React53.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
var NativeSelectInput = React54.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime39.jsxs)(React54.Fragment, {
    children: [(0, import_jsx_runtime39.jsx)(NativeSelectSelect, {
      ownerState,
      className: clsx_default(classes.select, className),
      disabled,
      ref: inputRef || ref,
      ...other
    }), props.multiple ? null : (0, import_jsx_runtime39.jsx)(NativeSelectIcon, {
      as: IconComponent,
      ownerState,
...
var SelectInput = React55.forwardRef(function SelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime40.jsxs)(React55.Fragment, {
    children: [(0, import_jsx_runtime40.jsx)(SelectSelect, {
      as: "div",
      ...
      children: isEmpty2(display) ? (
        // notranslate needed while Google Translate will not fix zero-width space issue
        _span4 || (_span4 = (0, import_jsx_runtime40.jsx)("span", {
          className: "notranslate",
          "aria-hidden": true,
          children: "​"
        }))
      ) : display
    }), (0, import_jsx_runtime40.jsx)(SelectNativeInput, {
      "aria-invalid": error,
      ...
      ...other,
      ownerState
    }), (0, import_jsx_runtime40.jsx)(SelectIcon, {
      as: IconComponent,
      className: classes.icon,
      ownerState
    }), (0, import_jsx_runtime40.jsx)(Menu_default, {
      id: `menu-${name || ""}`,
...
var ArrowDropDown_default = createSvgIcon((0, import_jsx_runtime41.jsx)("path", {
  d: "M7 10l5 5 5-5z"
}), "ArrowDropDown");
...
var Select = React57.forwardRef(function Select2(inProps, ref) {
  ...
  const InputComponent = input || {
    standard: (0, import_jsx_runtime42.jsx)(StyledInput, {
      ownerState
    }),
    outlined: (0, import_jsx_runtime42.jsx)(StyledOutlinedInput, {
      label,
      ownerState
    }),
    filled: (0, import_jsx_runtime42.jsx)(StyledFilledInput, {
      ownerState
    })
  }[variant];
  const inputComponentRef = useForkRef_default(ref, getReactElementRef(InputComponent));
  return (0, import_jsx_runtime42.jsx)(React57.Fragment, {
    children: React57.cloneElement(InputComponent, {
...
var TextField = React58.forwardRef(function TextField2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTextField"
  });
  ...
  const InputElement = (0, import_jsx_runtime43.jsx)(InputSlot, {
  ...
  return (0, import_jsx_runtime43.jsxs)(RootSlot, {
    ...rootProps,
    children: [label != null && label !== "" && (0, import_jsx_runtime43.jsx)(InputLabelSlot, {
      htmlFor: id,
      id: inputLabelId,
      ...inputLabelProps,
      children: label
    }), select ? (0, import_jsx_runtime43.jsx)(SelectSlot, {
      "aria-describedby": helperTextId,
      id,
      ...
      ...selectProps,
      children: children2
    }) : InputElement, helperText && (0, import_jsx_runtime43.jsx)(FormHelperTextSlot, {
      id: helperTextId,
      ...formHelperTextProps,
      children: helperText
    })]
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-NGJHREXL.js.map
